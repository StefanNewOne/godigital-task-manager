...
/** Админ → Автоматизации (H3 минимум): системски правила со on/off toggle. */
export function AdminAutomations() {
  ...
  return (
    <div>
      <h1 style={s.h1}>Автоматизации и аларми</h1>
      <p style={{ color: 'var(--gd-ink-muted)', fontSize: 13, marginTop: -8, marginBottom: 16 }}>
        Системските правила (PRD §13) со вклучување/исклучување. Rule Builder форма доаѓа во следен
        чекор.
      </p>
